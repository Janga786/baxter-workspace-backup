...
: ${AMENT_CURRENT_PREFIX:="/shared_ws/install/rethink_ee_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rethink_ee_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rethink_ee_description/environment/path.sh"
